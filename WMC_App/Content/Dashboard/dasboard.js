...
$(document).ready(function () {
    //$.get('/PooldataMachine/GetMenuList', function (data) {
    //    debugger;
    ...
    //        menuData += '<span>' + data[i].name + '</span>' +
    //                        '</a>';
    //        //Child
