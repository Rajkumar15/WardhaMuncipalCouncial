...
namespace WMC_App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                WMC_WebApplicationEntities db = new WMC_WebApplicationEntities();
               UserName =  db.tbl_UserDetails.Where(x => x.EmailId == model.Email || x.ContactNumber == model.Email).FirstOrDefault().UserName;
            }
            catch
            {
            ...
            if (model.Email != null || model.MobileNumber != null)
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        return RedirectToAction("SaveCustomer", "SuperAdmin");
                    }
                    AddErrors(result);
                }
            }
            else {
                ViewBag.Exception = "Mobile Number Or Email is Required";              
            }
